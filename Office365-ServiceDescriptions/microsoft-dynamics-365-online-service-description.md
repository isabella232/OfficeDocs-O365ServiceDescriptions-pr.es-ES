...
Para obtener más información sobre las características de Dynamics 365, vea [Microsoft Dynamics 365](https://www.microsoft.com/dynamics365/home). 
  
## <a name="dynamics-365-plans"></a>Planes de Dynamics 365

Dynamics 365 tiene dos ediciones: Enterprise y Business. Dentro de esas dos ediciones, hay varios planes disponibles específicamente diseñados para cumplir los patrones de uso y las necesidades de las organizaciones grandes y pequeñas. Las aplicaciones también están disponibles de forma individual.
...
|[Dynamics 365 para Operations](https://docs.microsoft.com/dynamics365/#pivot=solutions&amp;panel=solutions_operations)<sup>4</sup> <br/> |No  <br/> |Sí  <br/> |Sí  <br/> |No  <br/> |No  <br/> |
...
||||||||
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
||**Miembros del equipo** <br/> |**Lín** <br/> |**Servicio de atención al cliente** <br/> |**Servicio de campo** <br/> |**Automatización del servicio de Project** <br/> |**Plan 1** <br/> |
...
<br/><sup>2</sup> la creación, actualización y eliminación mediante flujos de trabajo solo se puede realizar en entidades incluidas en los derechos de uso (por ejemplo, la actualización de una oportunidad requiere ventas o el plan 1). 
<br/><sup>3</sup> no tiene acceso a la interfaz de usuario de Dynamics 365. Los chats y la administración de casos solo se pueden enviar en nombre propio de los usuarios, como parte del soporte técnico, no en nombre de un cliente u otra persona. 
<br/><sup>4</sup> la creación de PowerApps solo puede aprovechar los datos incluidos en la aplicación individual. 
