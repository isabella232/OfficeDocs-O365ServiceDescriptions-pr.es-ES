...
Busque y reemplace texto en el documento con la herramienta Buscar y reemplazar en Word para la aplicación de escritorio de Word y web. Para obtener más información sobre el uso de Buscar y reemplazar en Word para la web, vea [Buscar y reemplazar texto](https://support.office.com/article/c6728c16-469e-43cd-afe4-7708c6c779b7#ID0EAABAAA=Web).
...
Puede agregar notas al pie y notas al final a los documentos en Word para la web. Obtenga más información [sobre cómo agregar notas al pie y notas al final en Word para la web](https://go.microsoft.com/fwlink/p/?LinkId=397306).
...
Inserte un encabezado y un pie de página en el documento tanto en Word para la web como en la aplicación de escritorio de Word. También puede aplicar encabezados y pies de página en todas las páginas de un documento, excepto en la primera. Para obtener más información sobre el uso de encabezados y pies de página en Word para la [web,](https://go.microsoft.com/fwlink/?LinkId=389520)vea Novedades de Word para la web .
...
Puede usar Word para la web para guardar o convertir los archivos en ARCHIVOS PDF para que pueda compartirlos o imprimirlos con impresoras comerciales. Y no necesitará ningún otro software o complemento.
...
Cuando necesites lograr algo en Word para la web pero no sepas cómo hacerlo, puedes usar la característica de búsqueda Cuéteme para encontrar rápidamente lo que estás buscando. Esta característica comprende lo que intenta realizar y le sugiere cómo hacerlo rápidamente.
...
Word para la web le proporciona un recuento aproximado de palabras para las palabras del documento. Obtenga más información sobre [el recuento de palabras en Word para la web](https://go.microsoft.com/fwlink/p/?LinkId=271864).
  
## <a name="zoom"></a>Zoom

La característica de zoom está disponible en el modo de visualización. Con Word para la web, usa la configuración de vista del explorador para acercar o alejar el modo de edición. Obtenga más información sobre [el recuento de palabras en Word para la web](https://go.microsoft.com/fwlink/p/?LinkId=271864).
