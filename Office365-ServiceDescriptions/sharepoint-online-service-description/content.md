...
## <a name="accessibility-standards-support"></a>Soporte para estándares de accesibilidad
...
## <a name="asset-library-enhancementsvideo-support"></a>Mejoras y soporte de vídeo para la biblioteca de activos
...
## <a name="content-organizer"></a>Organizador de contenidos
...
Solo está disponible para las colecciones de sitios privados. La publicación entre sitios es un método de publicación que permite crear y mantener contenido en una o varias colecciones de sitios de creación y publicarlo en una o varias colecciones de sitios de publicación con los elementos web de búsqueda. Obtenga información sobre cómo [activar la característica de publicación entre sitios](https://go.microsoft.com/fwlink/p/?LinkId=330810).
...
## <a name="document-translation-in-word-online"></a>Traducción de documentos en Word Online
...
## <a name="ediscovery-hold"></a>Retención de la exhibición de documentos electrónicos
...
SharePoint Online IRM utiliza la protección de la información de Azure, una tecnología de protección de la información en Office 365. Protección de IRM se aplica a los archivos en los niveles de lista y biblioteca de SharePoint. Obtenga más información acerca de [IRM en SharePoint Online](https://go.microsoft.com/fwlink/?LinkId=270963).
...
## <a name="multi-stage-disposition"></a>Disposición multi-etapas
...
## <a name="office-online-view"></a>Office Online (vista)
...
## <a name="office-web-apps-server-integration"></a>Integración del servidor de Office Web Apps
...
## <a name="preservation-hold-library"></a>Biblioteca de conservación de documentos
...
## <a name="recycle-bin-sharepoint-admin-center"></a>Papelera de reciclaje (Centro de administración de SharePoint)
...
## <a name="recycle-bin-site-collection"></a>Papelera de reciclaje (colección de sitios)
...
El servicio de traducción automática permite a los usuarios traducir automáticamente los documentos. Puede crear una aplicación de servicio de traducción automática y configurar dicho servicio a través de la Administración central o de Windows PowerShell. Obtenga más información sobre cómo [crear y configurar los servicios de traducción automática en SharePoint Server 2013](https://go.microsoft.com/fwlink/?LinkId=270914).
  
## <a name="site-mailbox"></a>Buzones del sitio
...
## <a name="unique-document-ids"></a>Identificaciones de documento único
