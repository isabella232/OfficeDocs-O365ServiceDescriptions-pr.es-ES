...
- [Requisitos de licencia para usar Administración de identidades con privilegios](/azure/active-directory/privileged-identity-management/subscription-requirements)
