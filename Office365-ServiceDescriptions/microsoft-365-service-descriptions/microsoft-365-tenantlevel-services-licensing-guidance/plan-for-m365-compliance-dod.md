...
| --------------------------------------- | ----------------------------------------------- | ---------------------- |
| **Protección de la información**              | Etiquetas unificadas y de confidencialidad         | Publicación              |
...
|                                         | Indicadores de Office para equipos, sitios de SharePoint, mensajes de correo electrónico                         | Sobre el trabajo pendiente de ingeniería |
|                                         | Robo de datos al pertenecer a los usuarios                        | Sobre el trabajo pendiente de ingeniería |
|                                         | Pérdidas de datos generales                                | Sobre el trabajo pendiente de ingeniería              |
|                                         | Investigar las alertas de administración de riesgos de Insider                                   | Sobre el trabajo pendiente de ingeniería              
|                                         | Panel de caso de administración de riesgos de Insider, plantillas de aviso y explorador de contenido | Sobre el trabajo pendiente de ingeniería |
|                                         | Escalar para la investigación de eDiscovery avanzado |Sobre el trabajo pendiente de ingeniería|
...
|                                         | Crear directivas de cliente, 3 preconfiguradas para el cumplimiento de comunicaciones (incl. directivas de supervisión)  | sobre el trabajo pendiente de ingeniería |
|                                         | Compatibilidad con la comunicación (directivas de control incl.) para Teams, Exchange y quitar mensajes de Microsoft Teams |sobre el trabajo pendiente de ingeniería |
|                                         | Cumplimiento de comunicaciones (directivas de supervisión incl.) acceso a alertas; plantillas de aviso; panel de directivas de comunicación |sobre el trabajo pendiente de ingeniería  |
|                                         | Cumplimiento de la comunicación (con directivas de supervisión) escala para la investigación para la exhibición avanzada de documentos electrónicos | sobre el trabajo pendiente de ingeniería |
|                                         | Cumplimiento de comunicaciones (directivas de supervisión incl.) detectar contenido para adultos | sobre el trabajo pendiente de ingeniería |
