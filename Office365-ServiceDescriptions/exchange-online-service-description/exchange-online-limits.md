...
Para conocer los límites de seguimiento de mensajes y creación de informes, vea la sección sobre disponibilidad y latencia de datos de seguimiento de mensajes y creación de informes en [Informes y seguimiento de mensajes en la Protección en línea de Exchange](https://go.microsoft.com/fwlink/p/?LinkId=394248).
...
|Número máximo de propietarios de un grupo de distribución|metros|metros|metros|metros|metros|metros|
...
|Número máximo de propietarios de un grupo de distribución|metros|metros|metros|metros|
