...
Si es administrador, puede encontrar instrucciones detalladas para configurar las características de Skype empresarial online en [configurar Skype empresarial online](https://support.office.com/article/40296968-e779-4259-980b-c2de1c044c6e).
...
- Mostrar su estado de presencia, &mdash; por ejemplo, disponible, ausente, no molestar o sin conexión &mdash; para que otros usuarios sepan su disponibilidad. La información de presencia de Skype empresarial se presenta en todo el conjunto de aplicaciones.
...
Puede obtener más información acerca de la mensajería instantánea, la presencia y los contactos en [Enviar un mensaje instantáneo en Skype empresarial](https://support.office.com/article/b3aefb9b-dec8-4be8-a1ee-1eab12144d05).
...
Los usuarios pueden iniciar una reunión de Skype empresarial ad-hoc o unirse a ella fácilmente en el cliente de Skype empresarial o en Office. Skype Empresarial permite a los usuarios convertir conversaciones simples de mensajería instantánea o de correo electrónico en reuniones de audio y vídeo entre varios usuarios (tres o más) basadas en PC, con documentos, aplicaciones y escritorios compartidos.
...
- Combine mensajes de voz y mensajes de correo electrónico en una sola infraestructura de mensajería disponible desde el cliente de Skype empresarial. La mensajería unificada de Exchange y Skype Empresarial funciona de forma conjunta para proporcionar servicios de contestador automático, Outlook Voice Access y operador automático.
