...
Las siguientes características de la funcionalidad principal están disponibles en Project Online.
...
## <a name="enhanced-copy-and-paste-across-microsoft-office-applications"></a>Funciones copiar y pegar mejoradas en aplicaciones de Microsoft Office
...
## <a name="gantt-chart-calendar-and-task-sheet-views"></a>Vistas de diagrama de Gantt, calendario y hoja de tareas
<a name="bkmk_Ganttchartcalendartasksheetview"> </a>

Presente la información del proyecto de manera gráfica con las vistas de diagrama de Gantt, diagrama de red, gráfico, hoja, uso y formulario. Vea [Seleccionar la vista adecuada para su programación de proyecto](https://go.microsoft.com/fwlink/?LinkId=402905).
  
## <a name="microsoft-fluent-user-interface-the-ribbon"></a>Interfaz de usuario de Microsoft Fluent, la cinta de opciones
...
¿Necesita una aplicación que lo ayude con Project? En la Tienda Office encontrará nuevas aplicaciones para Project. Vea [Complementos para Project](https://go.microsoft.com/fwlink/?LinkId=273883).
  
## <a name="online-help"></a>Ayuda en línea
<a name="bkmk_Online_help_PP"> </a>

La ayuda de Project está a un solo clic en Office.com o en las Guías de introducción, directamente en Project (haga clic en **Archivo** \> **Nuevo**). [Vea estos vídeos para cambiar a Project 2013](https://go.microsoft.com/fwlink/p/?LinkId=271325).
  
## <a name="pdf-and-xps-output"></a>Salida PDF y XPS
<a name="bkmk_PDFXPSoutput"> </a>

Puede guardar un archivo de Project en un archivo PDF o XPS. Vea [Guardar un archivo de proyecto como PDF](https://go.microsoft.com/fwlink/p/?LinkId=271350).
  
## <a name="placeholder-text-in-project-fields"></a>Texto de marcador de posición en campos de proyectos
...
## <a name="project-templates"></a>Plantillas de proyectos
