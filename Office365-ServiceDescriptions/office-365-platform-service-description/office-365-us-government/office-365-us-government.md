...
En respuesta a los requisitos únicos y en evolución del sector público de Estados Unidos, Microsoft ha creado planes de Office 365 Government (u Office 365 Government). Esta descripción del servicio proporciona una introducción a las características específicas de los entornos de Office 365 Government US. Se recomienda leer esta descripción del servicio junto con otras descripciones de servicios de [Microsoft 365 y Office 365](../../office-365-service-descriptions-technet-library.md).

## <a name="how-to-use-this-service-description"></a>Cómo utilizar esta descripción del servicio

La descripción del servicio de Office 365 Government está diseñada para servir como una superposición a la descripción general del servicio de Office 365. Define los compromisos y diferencias únicos con respecto a las ofertas de Office 365 Enterprise.

## <a name="about-office-365-government-environments"></a>Acerca de los entornos de Office 365 Government
...
- El entorno GCC de **Office 365** proporciona cumplimiento con los requisitos federales para los servicios en la nube, incluido FedRAMP High, y los requisitos para la justicia penal y los sistemas de información fiscal federal (tipos de datos CJI y FTI).

- Los entornos de Office **365 GCC High y DoD** cumplen con las Directrices de requisitos de seguridad del Departamento de Defensa, el complemento de reglamentos de adquisición federal de defensa (DFARS) y el Reglamento de tráfico internacional de armas (ITAR).

Además de las características y capacidades de Office 365, las organizaciones que usan Office 365 Government se benefician de las siguientes características exclusivas de Office 365 Government:
...
- Office 365 Government cumple con las certificaciones y acreditaciones necesarias para los clientes del sector público de Estados Unidos.

## <a name="customer-eligibility"></a>Idoneidad del cliente

Office 365 Government está disponible para (1) entidades gubernamentales federales, estatales, locales, tribales y territoriales de Estados Unidos y (2) otras entidades que administran datos que están sujetos a normativas y requisitos gubernamentales y donde el uso de Office 365 Government es adecuado para cumplir estos requisitos, sujeto a la validación de la elegibilidad. La validación de la idoneidad por parte de Microsoft incluirá la confirmación del tratamiento de datos de conformidad con el Reglamento internacional de tráfico de armas (ITAR), datos de cumplimiento de la ley de conformidad con la directiva de los Servicios de Información de Justicia Criminal (CJIS) del FBI u otros datos regulados o controlados por el gobierno. La validación puede requerir una prueba del registro en el Departamento de Estado de los Estados Unidos en el caso de los datos de ITAR o del patrocinio por un ente gubernamental con requisitos específicos para el tratamiento de los datos. El entorno doD de Office 365 es para el uso exclusivo del Departamento de Defensa de Los Estados Unidos.

Aunque los criterios de elegibilidad son coherentes en todas las ofertas de Office 365 Government, Microsoft solo aceptará el lenguaje de contrato DFARS y ITAR para el entorno de GCC High.

Las entidades con preguntas acerca de la elegibilidad para Office 365 Government deben consultar a su equipo de cuenta.

Tras la renovación del contrato de un cliente para Office 365 Government, se requiere la revalidación de la elegibilidad.
...
La página Uso del sitio para sitios de SharePoint está disponible para planes gubernamentales, aunque por cumplimiento, hay algunas características de esta página que solo están disponibles para clientes comerciales. Para obtener más información, vea Página de uso del sitio para [sitios de SharePoint en Microsoft 365](https://support.microsoft.com/office/2fa8ddc2-c4b3-4268-8d26-a772dc55779e).

## <a name="office-365-government-and-third-party-services"></a>Servicios gubernamentales y de terceros de Office 365
...
El acceso al contenido del cliente de Office 365 Government por parte de los administradores de Microsoft está restringido al personal con pantalla. Para obtener información detallada sobre los niveles de filtrado, consulte la página de descripción del servicio para cada entorno respectivo (GCC o GCC High y DoD).

## <a name="fasttrack-center-onboarding-assistance"></a>Asistencia para la incorporación del Centro FastTrack
...
Los clientes que elijan [la ventaja de migración de FastTrack](https://fasttrack.microsoft.com/) tendrán que conceder acceso al equipo que administra sus migraciones de datos. Estos empleados son ciudadanos estadounidenses y se someten a las siguientes comprobaciones de antecedentes antes de realizar migraciones para los clientes de los servicios de Office 365 US Government.<br><br>
...
Los clientes de Office 365 US Government pueden usar los servicios de Azure Government ExpressRoute para conectarse privadamente a los servicios de Office 365 compatibles en lugar de conectarse a través de Internet pública.
...
Para obtener más información sobre la compatibilidad de Office 365 con Azure ExpressRoute, vea [Azure ExpressRoute for Office 365](/microsoft-365/enterprise/azure-expressroute)
...
|Servicio de Office 365|Office 365 Administración Pública G1|Office 365 Administración Pública G3|Office 365 Administración Pública G5|Office 365 Government F3|
|---|---|---|---|---|
...
<br/><sup>2</sup> No se incluye, pero se puede comprar como un complemento independiente. Project Online incluye Project Online Desktop Client como parte de la suscripción.
<br/> <sup>3</sup> Todavía no está disponible en los planes GCC High o DoD, pero próximamente.
<br/><sup>4</sup> Yammer Enterprise no es un componente de Office 365 US Government, pero puede adquirirse sin costo como una oferta independiente para cada usuario con licencia para Office 365 en GCC. Actualmente, esta oferta está limitada a los clientes que adquieran GCC de Office 365 en contratos de empresa y contratos de suscripción empresarial. Yammer no está disponible en GCC High o DoD.
...
|Característica|Office 365 Administración Pública G1|Office 365 Administración Pública G3|Office 365 Administración Pública G5|Office 365 Government F3|
|---|---|---|---|---|
...
|**[Características del conjunto de aplicaciones de Office 365](../../office-365-platform-service-description/office-365-suite-features.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[Administración de cuentas de usuario](../../office-365-platform-service-description/user-account-management.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[Dominios](../../office-365-platform-service-description/domains.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[Continuidad y estado del servicio](../../office-365-platform-service-description/service-health-and-continuity.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[Informes](../../office-365-platform-service-description/reports.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[Actualizaciones de servicio](../../office-365-platform-service-description/service-updates.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[Ayuda y formación](../../office-365-platform-service-description/help-and-training.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[Conexión de red](../../office-365-platform-service-description/networking.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
|Protocolos IPv4 e IPv6|Sí|Sí|Sí|Sí|
|**Confianza**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
|**[BlackBerry](../../office-365-platform-service-description/blackberry.md)**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
<br/><sup>6</sup> Solo puede tener un sitio web público con Office 365, a menos que haya actualizado desde una versión anterior de Office 365. En ese caso, tiene dos sitios web públicos, pero solo se puede hospedar uno de ellos con un nombre de dominio personalizado. Para obtener más información sobre cómo trabajar con las dos suscripciones a sitios web para empresas, vea Trabajar con los dos sitios web públicos de [Office 365](https://go.microsoft.com/fwlink/p/?LinkID=271589). Si tiene una suscripción diferente, obtenga más información sobre los sitios web públicos en Más información sobre el hospedaje de sitios web asociados y los sitios web públicos [en Office 365](https://go.microsoft.com/fwlink/p/?LinkID=325009).
...
<br/><sup>8</sup> Los siguientes planes no admiten cambios de puestos de licencia del Centro de administración de Microsoft 365: Office 365 Government G1, Office 365 Government G3, Office 365 Government F3.
<br/><sup>9</sup> Todavía no está disponible en GCC High, pero próximamente.
<br/><sup>10</sup> Para Office 365 Government G1, G3 y F3, se aplican la versión dirigida y la guía básica de Office 365 para empresas; sin embargo, puede haber algunas diferencias o retrasos para actualizaciones de servicio específicas debido a los [requisitos de cumplimiento](https://www.microsoft.com/trust-center).
<br/><sup>11</sup> Todavía no está disponible en las ofertas de Office 365 Government, pero próximamente.
<br/><sup>12</sup> No se incluye, pero se puede comprar como un complemento independiente en GCC.
<br/><sup>13</sup> No compatible con las ofertas de Office 365 Government.
...
<br/><sup>19</sup> Todavía no está disponible en el entorno GCC, pero próximamente.
...
## <a name="office-application-availability-and-enterprise-value"></a>Disponibilidad de aplicaciones de Office y valor de empresa
...
|Aplicación/característica|Office 365 Administración Pública G1|Office 365 Administración Pública G3|Office 365 Administración Pública G5|Office 365 Government F3|
|---|---|---|---|---|
...
|**Valor de empresa**|**Office 365 Administración Pública G1**|**Office 365 Administración Pública G3**|**Office 365 Administración Pública G5**|**Office 365 Government F3**|
...
<br/><sup>3</sup> Skype Empresarial Basic está disponible para todos los clientes. El cliente de escritorio de Skype Empresarial es una aplicación instalada localmente que proporciona funciones de presencia, de mensajería instantánea y de conferencias para los planes de Office 365 que incluyen Skype Empresarial Online. Las aplicaciones de Microsoft 365 para empresas y Office 365 Enterprise E3 incluyen la aplicación de Skype completa, que incluye características adicionales como la compatibilidad avanzada de telefonía, el archivado y las características de cumplimiento. A Skype for Business Online license must be assigned for each user. For more information on Lync Basic features, see [Skype for Business Online client comparison tables](/lyncserver/lync-server-2013-desktop-client-comparison-tables).
<br/><sup>4</sup> Todavía no está disponible en entornos GCC High o DoD, pero próximamente.
<br/><sup>5</sup> Vea [Usar Outlook para iOS y Android en la nube](/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/outlook-for-ios-and-android-in-the-government-cloud) de la comunidad gubernamental para obtener más información.
<br/><sup>6</sup> Todavía no está disponible en el entorno doD de Office 365, pero próximamente.
<br/><sup>7</sup> Las aplicaciones están totalmente disponibles en las nubes gubernamentales, a excepción de las características específicas que no están disponibles en este momento. Consulte [Disponibilidad de características de aplicación de Office](#office-application-and-feature-availability-in-government-plans) para obtener más información.

## <a name="office-application-and-feature-availability-in-government-plans"></a>Disponibilidad de aplicaciones y características de Office en planes de gobierno
...
|Colaboración en tiempo real (presencia, coautoría regular, chat en el documento)|No|No|No|
...
|Tinta digital inteligente|No|No|No|
|[**Microsoft Outlook**](../../office-applications-service-description/office-applications.md#microsoft-outlook) está totalmente disponible en las nubes gubernamentales excepto las siguientes características, que **no están** disponibles en este momento:|**GCC**|**GCC High**|**DOD**|
...
|[**Microsoft PowerPoint**](../../office-applications-service-description/office-applications.md#microsoft-powerpoint) está totalmente disponible en las nubes gubernamentales excepto las siguientes características, que **no están** disponibles en este momento:|**GCC**|**GCC High**|**DOD**|
|Búsqueda inteligente|No|No|No|
|Sonidos de Office (algunos)|No|No|No|
|Modelos 3D y animaciones incrustadas en 3D|No|No|No|
|Gráficos: mapas|No|No|No|
|Tinta digital inteligente|No|No|No|
|Subtítulos y títulos en directo en PowerPoint|No|No|No|
...
|**Microsoft Whiteboard** in government clouds is currently only available on Hub clients, and not on the desktop.|**GCC**<sup>2</sup>|**GCC High**<sup>2</sup>|**DOD**<sup>2</sup>|
|Insertar notas pegajosas, texto e imágenes|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|
|Tinta para dar forma y tinta a la tabla|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|
|Embellecimiento de tinta|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|
|Convertir imagen a lápiz|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|Sí<sup>2</sup> <br/>|
...
|Reacciones en el contenido|No|No|No|
|Galería de pizarras de pizarras, incluidas las compartidas con usted|No|No|No|
|[**Microsoft Word**](../../office-applications-service-description/office-applications.md#microsoft-word) está totalmente disponible en las nubes gubernamentales, excepto las siguientes características, que **no están** disponibles en este momento:|**GCC**|**GCC High**|**DOD**|
|Búsqueda inteligente|No|No|No|
|Investigador|No|No|No|
...
Para obtener disponibilidad de características para Microsoft Teams en GCC/GCC High/DoD, visite la [descripción del servicio de Microsoft Teams](../../teams-service-description.md).
...
<br/><sup>4 La</sup> característica de formularios de grupo recientes está deshabilitada para el entorno GCC. Sin embargo, los usuarios aún pueden tener acceso a los formularios de grupo seleccionando un grupo específico en la pestaña Formularios de grupo.
<br/>Solo cliente de Windows de PowerPoint de Excel de <sup>5</sup> Word, no web, MacOS, iOS o Android.