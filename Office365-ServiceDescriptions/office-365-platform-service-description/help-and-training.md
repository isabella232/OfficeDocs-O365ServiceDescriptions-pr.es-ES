...
- [Vídeos de aprendizaje de Office 365](https://go.microsoft.com/fwlink/p/?LinkId=286119)
    
- [Eventos de aprendizaje de Office 365 para profesionales de TI](https://go.microsoft.com/fwlink/p/?LinkId=288858)
    
- [Seminarios web gratuitos](https://go.microsoft.com/fwlink/?LinkId=517279)
    
- [Cursos de autoaprendizaje de Office 365 para profesionales de TI](https://www.microsoftvirtualacademy.com/product-training/office-365?Prid=fusion-www)
    
- [Cursos de autoaprendizaje de Office 365 para usuarios finales](https://www.microsoftvirtualacademy.com/product-training/office_365?Prid=fusion-www)
...
En la página de inicio de la Comunidad de Office 365, los clientes pueden obtener acceso a los siguientes recursos:
  
- **Foros** Los foros tienen el objetivo de proporcionar a los participantes de la comunidad un recurso en línea en el que pueden publicar dudas sobre soporte técnico y comentar temas relacionados con los servicios de Office 365. A continuación, se mencionan los foros disponibles: 
    
  - Implemente Office 365
    
  - Servicios de integración de directorio
    
  - Dominios en Office 365
    
  - Descargas
    
  - Correo electrónico y calendario
    
  - MI, reuniones y conferencias
  ...
  - Sitios y uso compartido de documentos
    
  - Documentos del Centro de confianza
    
  - Actualización a Office 365
...
- **Blogs** El blog técnico de Office 365 es un buen recurso para obtener información actual sobre los servicios en línea de Office 365 y para obtener información sobre las ventajas de las características y funciones de Office 365. Los temas incluyen información sobre productos, anuncios de productos nuevos, entrevistas a clientes y una serie de blogs de invitados. 
    
Para obtener más información, visite la [Comunidad de Office 365](https://techcommunity.microsoft.com/).
  
## <a name="manage-office-365-guidance"></a>Guía para la administración de Office 365

Los profesionales de TI de organizaciones grandes pueden visitar la página de inicio de la documentación de administración de Office 365. Esta página proporciona vínculos a instrucciones de implementación complejas destinadas a organizaciones de gran tamaño.
  
Para obtener más información, visite [administrar Office 365](https://docs.microsoft.com/Office365/).
