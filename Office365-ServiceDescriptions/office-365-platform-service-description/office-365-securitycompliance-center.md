...
El [Centro de cumplimiento &amp; de](https://protection.office.com/) seguridad está diseñado para ayudarle a administrar las características de cumplimiento en Office 365 para su organización. Los vínculos a las características de cumplimiento existentes de SharePoint y Exchange reúnen las capacidades de cumplimiento en Office 365.
...
|[Administración avanzada de amenazas,](https://docs.microsoft.com/office365/securitycompliance/office-365-ti)como el explorador de amenazas para campañas de suplantación de identidad   |No   |No   |No   |No   |No   |No   |No   |No   |No  |
...
|[Gobierno avanzado de la información](https://docs.microsoft.com/office365/securitycompliance/labels)<sup>3</sup>  |No   |No   |No   |No   |No   |No   |No   |No   |No   |
...
|[eDiscovery](https://docs.microsoft.com/office365/securitycompliance/compliance20/overview-ediscovery-20)<sup>avanzado 5</sup>  |No   |No   |No   |No   |No   |No   |No   |No   |No   |
...
<sup>1 El</sup> gobierno de la información permite a los usuarios crear, publicar y aplicar etiquetas manualmente a los documentos; importar datos mediante el envío de unidades o a través de la red. Estas características están disponibles en E3 y E5, con solo disponibilidad limitada en E1. Para obtener una lista completa de las características disponibles en E1, E3 y E5, consulte la comparación detallada de licencias de cumplimiento de Microsoft 365. [(PDF)](https://docs.microsoft.com/office365/servicedescriptions/downloads/microsoft-365-compliance-licensing-comparison.pdf)  |  [(Excel)](https://docs.microsoft.com/office365/servicedescriptions/downloads/microsoft-365-compliance-licensing-comparison.xlsx)

<sup>2</sup> Requiere la compra de Archivado de Exchange Online complemento.

<sup>3</sup> El gobierno avanzado de la información le permite conservar información importante y eliminar información no importante mediante la clasificación de la información en función de una directiva de retención o eliminación o ambas. Incluye acciones inteligentes y automatizadas, como recomendar directivas, aplicar automáticamente etiquetas a los datos, aplicar etiquetas basadas en tipos o consultas de datos confidenciales, revisión de disposición y uso de filtros de importación inteligente. También incluye la característica de supervisión para revisar las comunicaciones de los empleados por motivos de seguridad y cumplimiento.

<sup>4 conversaciones</sup> de Skype se almacenan como parte del buzón.

<sup>5</sup> eDiscovery avanzado requiere Office 365 E5 o una licencia de complemento.

<sup>6 El</sup> archivado de Skype está dentro del buzón del usuario.

<sup>7 Incluye</sup> archivos almacenados en repositorios de Microsoft Teams.

<sup>Se conservan 8</sup> registros de auditoría de todos los planes que incluyen auditoría básica durante 90 días. Además, puede usar la API de actividad de administración de [Office 365](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference) para recuperar eventos del registro de auditoría unificado.
...
<sup>11</sup> Se requiere una licencia de Archivado de Exchange Online o plan 2 de Exchange Online para poner un buzón de usuario en suspensión mediante una directiva de retención.
...
El Centro de & cumplimiento está disponible para Office 365 Germany. Para obtener información sobre Office 365 Germany, vea [Office 365 Germany.](office-365-germany.md)
